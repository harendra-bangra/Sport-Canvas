...
L.tileLayer(
  "https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoibmdlbm92aWN0b3IzMjEiLCJhIjoiY2lmeWhzejVlMDJoaXU0bHp2NDcza2NteiJ9.xbQkW7UhxjnDXZT9ZQS1Rg",
  {
...
$(document).ready(function () {
  ...
  $("section#mapinfo .row .cols .mapinfo#routes").click(function () {
    ...
    $("section#mapinfo .row .cols #routeresult").append(
      "<div class='row'><div class='attr'></div><div class='name'></div></div>"
    );
    L.geoJson(routes, {
      onEachFeature: function (feature, layer) {
        $("section#mapinfo .row .cols #routeresult .name").append(
          $("<p>" + feature.properties.Name + "</p>").click(function () {
            $("section#mapinfo .row .cols #routeresult .attr").text("");
            $("section#mapinfo .row .cols #routeresult .attr").append(
              "<p>Distance: " + feature.properties.Distance + " Kms</p>"
            );
  ...
  $("section#mapinfo .row .cols .mapinfo#facilities").click(function () {
    ...
    $("section#mapinfo .row .cols #facilityresult").append(
      "<div class='row'><div class='attr'></div><div class='name'></div></div>"
    );
    L.geoJson(facilities, {
      onEachFeature: function (feature, layer) {
        $("section#mapinfo .row .cols #facilityresult .name").append(
          $(
            "<div class='col-xs-5 bck'><p>" +
              feature.properties.Name +
              "</p></div>"
          ).click(function () {
            $(
              "section#mapinfo .row .cols #facilityresult .name .bck"
            ).mouseenter(function () {
            ...
            $("section#mapinfo .row .cols #facilityresult .attr").append(
