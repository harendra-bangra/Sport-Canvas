!(function (t, e, i) {
  ...
  "object" == typeof module && "object" == typeof module.exports
    ...
    (o.Util = {
      ...
      stamp: function (t) {
        return (
          (t._leaflet_id = t._leaflet_id || ++o.Util.lastId), t._leaflet_id
        );
      },
      lastId: 0,
    ...
    (o.Class.extend = function (t) {
      ...
      return (
        ...
        t.includes &&
          ...
          delete t.includes),
        n.options &&
          (t.options = o.Util.extend(o.Util.create(n.options), t.options)),
        o.extend(n, t),
        (n._initHooks = []),
    ...
    (o.Evented = o.Class.extend({
      ...
      removeEventParent: function (t) {
        return (
          this._eventParents && delete this._eventParents[o.stamp(t)], this
        );
      },
  ...
  (s.addEventListener = s.on),
    ...
    (function () {
      ...
      o.Browser = {
        ...
        pointer: !!m,
        retina:
          (t.devicePixelRatio || t.screen.deviceXDPI / t.screen.logicalXDPI) >
          1,
      };
    })(),
      ...
      removeClass: function (t, e) {
        t.classList !== i
          ...
          : o.DomUtil.setClass(
              t,
              o.Util.trim(
                (" " + o.DomUtil.getClass(t) + " ").replace(" " + e + " ", " ")
              )
            );
      },
    ...
    (o.LatLngBounds.prototype = {
      ...
      contains: function (t) {
        t =
          "number" == typeof t[0] || t instanceof o.LatLng || "lat" in t
            ? o.latLng(t)
            : o.latLngBounds(t);
        var e,
          i,
    ...
    (o.Map = o.Evented.extend({
      ...
      _fireDOMEvent: function (t, e, i) {
        ...
        if (
          !t._stopped &&
          ((i = (i || []).concat(this._findEventTargets(t, e))), i.length)
        ) {
          var s = i[0];
          "contextmenu" === e &&
            s.listens(e, !0) &&
      ...
      _getTopLeftPoint: function (t, e) {
        var n =
          t && e !== i ? this._getNewPixelOrigin(t, e) : this.getPixelOrigin();
  ...
  (o.DomEvent = {
    ...
    (o.Projection.Mercator = {
      ...
      project: function (t) {
        var e = Math.PI / 180,
          ...
          a = r * Math.sin(n),
          h =
            Math.tan(Math.PI / 4 - n / 2) / Math.pow((1 - a) / (1 + a), r / 2);
        return (
          (n = -i * Math.log(Math.max(h, 1e-10))), new o.Point(t.lng * e * i, n)
        );
      },
      unproject: function (t) {
        for (
    ...
    (o.GridLayer = o.Layer.extend({
      ...
      bringToFront: function () {
        return (
          this._map &&
            (o.DomUtil.toFront(this._container), this._setAutoZIndex(Math.max)),
          this
        );
      },
      bringToBack: function () {
        return (
          this._map &&
            (o.DomUtil.toBack(this._container), this._setAutoZIndex(Math.min)),
          this
        );
      },
      getContainer: function () {
        ...
        if (n) {
          ...
          if ((t === i && (t = n.getCenter()), this._tileZoom !== i)) {
            ...
            for (var d in this._tiles) {
              ...
              (_.z === this._tileZoom && c.contains(o.point(_.x, _.y))) ||
    ...
    o.Layer.include({
      bindTooltip: function (t, e) {
        return (
          t instanceof o.Tooltip
            ...
            : ((this._tooltip && !e) || (this._tooltip = o.tooltip(e, this)),
      ...
      _openTooltip: function (t) {
        ...
        this._tooltip &&
          this._map &&
          this.openTooltip(e, this._tooltip.options.sticky ? t.latlng : i);
      },
    ...
    (o.Renderer = o.Layer.extend({
      ...
      onAdd: function () {
        this._container ||
          (this._initContainer(),
          this._zoomAnimated &&
            o.DomUtil.addClass(this._container, "leaflet-zoom-animated")),
          this.getPane().appendChild(this._container),
          this._update(),
    ...
    (o.Polyline = o.Path.extend({
      ...
      getCenter: function () {
        ...
        for (t = 0, n = 0; t < h - 1; t++)
          if (
            ((o = a[t]), (s = a[t + 1]), (i = o.distanceTo(s)), (n += i), n > e)
          )
            return (
              (r = (n - e) / i),
        ...
        ? {
            ...
            _update: function () {
              this._map._animatingZoom ||
                (o.Renderer.prototype._update.call(this), this.fire("update"));
            },
            _initPath: function (t) {
          ...
          if (a) {
            for (
              this._drawnLayers[t._leaflet_id] = t,
                h.beginPath(),
                h.setLineDash &&
                  h.setLineDash((t.options && t.options._dashArray) || []),
                i = 0;
              i < a;
              i++
            ) {
    ...
    (o.Control.Layers = o.Control.extend({
      ...
      _initLayout: function () {
        ...
        (s.href = "#"),
          (s.title = "Layers"),
          o.Browser.touch
            ? o.DomEvent.on(s, "click", o.DomEvent.stop).on(
                s,
                "click",
                this.expand,
                this
